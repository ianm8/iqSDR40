...
namespace spectrum
{
  ...
  static const uint8_t log16(const uint32_t l)
  {
    ...
    if (l>1023) return 0x0fu;
    static const uint8_t logtab16[1024] = 
    {
      0u,
      0u,
      0u,
  ...
  static const uint8_t log16_old(const uint32_t l)
  {
    // return a 4 bit log value
  ...
  */
  ...
  void process(int16_t ii[], int16_t qq[],uint8_t mag[])
  {
    int16_t re[N_WAVE] = { 0 };
    int16_t im[N_WAVE] = { 0 };
    ...
    for (uint32_t i = 0; i < N_WAVE; i++)
    {
      ...
      const uint16_t mag_value = abs(value_re);
    ...
    for (uint32_t i = 0; i < N_WAVE; i++)
    {
      const int32_t value_re = (int32_t)re[i];
      const int32_t value_im = (int32_t)im[i];
